        ...
        <div class="page-header">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><span>Add-News</span></li>
                </ol>
            </nav>
                        ...
                        <div class="card-body" style="margin-top: 20px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea class="form-control content"  placeholder="Nội dung" name="content"  style="height: 100px">{{old('content')}}</textarea>
                                </div>
                                @error("content")
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       <span class="input-group-btn">
                                        ...
                                        <input id="image" class="form-control" type="text" value="{{old('image')}}" name="image">
                                    </div>
                                    @error("image")
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       <span class="input-group-btn">
                                        ...
                                        <input id="image2" class="form-control" value="{{old('image2')}}" type="text" name="image2">
                                    </div>
                                    @error("image2")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
