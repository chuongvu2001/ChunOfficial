            ...
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>Add-CateNew</span></li>
                    </ol>
                </nav>
...
@section('content')
    <div class="container">
       <form action="{{route('catenew.name')}}" id="add-cate-form" method="POST">
           @csrf
            <div class="row">
                    ...
                    <div class="card component-card_6" style="margin: 0px !important; width:100% !important;">
                        <div class="card-body" style="margin-top: 20px;">
                            <div class="card-header">
                                <h4 class="m-0 font-weight-bold text-primary">Add Categories News</h4>
                            </div>
                            <div class="card-body">
