            ...
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>Sửa sản phẩm</span></li>
                    </ol>
                </nav>
...
@section('content')
    <div class="container">
        <form action="{{url('admin/san-pham/edit/'.$product->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                        ...
                        <div class="card-body" style="margin-top: 20px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" value="{{old('name',$product->name)}}" name="name" placeholder="Nhập tên sản phẩm">
                                    @error("name")
                                ...
                                <div class="form-floating">
                                    ...
                                    <textarea name="shorts" class="form-control short">{{old('shorts',$product->shorts)}}</textarea>
                                    @error("shorts")
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                <div class="form-floating mt-3">
                                    ...
                                    {{-- <textarea class="form-control"  name="content" id="postTextArea" style="height: 100px"></textarea> --}}
                                    <textarea name="description" class="form-control my-editor">{{old('description',$product->description)}}</textarea>
                                </div>
                                @error("description")
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                    ...
                    <div class="card component-card_6" style="margin: 0px !important; width:100% !important;">
                        <div class="card-body" style="margin-top: 20px">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                   <span class="input-group-btn">
                                    ...
                                    <input id="thumbnail" class="form-control" value="{{old('image',$product->image)}}" type="text" name="image">
                                    @error("image")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                   <span class="input-group-btn">
                                    ...
                                    <input id="thumbnail1" class="form-control" type="text" value="{{old('thumbnail1',$product->thumbnail1)}}" name="thumbnail1">
                                    @error("thumbnail1")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                   ...
                                   <span class="input-group-btn">
                                     <a id="lfm2" data-input="thumbnail2" data-preview="holder" class="btn btn-primary">
                                       <i class="fa fa-picture-o"></i> Choose
                                        ...
                                        <input id="thumbnail2" class="form-control" value="{{old('thumbnail2',$product->thumbnail2)}}" type="text" name="thumbnail2">
                                        @error("thumbnail2")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                   ...
                                   <span class="input-group-btn">
                                     <a id="lfm3" data-input="thumbnail3" data-preview="holder" class="btn btn-primary">
                                       <i class="fa fa-picture-o"></i> Choose
                                        ...
                                        <input id="thumbnail3" class="form-control" type="text" value="{{old('thumbnail3',$product->thumbnail3)}}" name="thumbnail3">
                                        @error("thumbnail3")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="price_sale" name="price_sale" value="{{old('price_sale',$product->price_sale)}}" placeholder="Nhập giá sale">
                                @error("price_sale")
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="brand" name="brand" value="{{old('brand',$product->brand)}}" placeholder="Thương hiệu">
                            </div>
                            @error("brand")
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sku" name="sku" value="{{old('sku',$product->sku)}}" placeholder="Đơn vị phân loại">
                                @error("sku")
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
