        ...
        <li>
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('admin/giam-gia')}}">Mã giảm giá</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><span>{{$voucher->name}}</span></li>
                    </ol>
                </nav>
            </div>
        </li>
...
@section('content')
    <table id="style-3" class="table style-3  table-hover">
        ...
        <tr>
            ...
            <th class="text-center" > Voucher_name </th>
        ...
        @foreach($user as $c => $item)
            <tr>
                ...
                <td class="text-center">{{$item->voucher_name}}</td>
                <td class="text-center">{{$item->user_name}}</td>
                <td class="text-center">{{$item->email}}</td>
                @if($item->attr_status == 1)
                    <td class="text-center"><a href="javascript:;"><span class="shadow-none badge badge-success">ON</span></a></td>
                @else
                    <td class="text-center"><a href="javascript:;"><span class="shadow-none badge badge-danger">OFF</span></a></td>
                @endif
                <td class="text-center">
                    <ul class="table-controls">
                        <li><a href="{{url('admin/abc/edit/'.$item->voucher_id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 p-1 br-6 mb-1"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
                        <li><a onclick="return remove({{$item->voucher_id}})" href="javascript:;" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash p-1 br-6 mb-1"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></a></li>
                    </ul>
                </td>
                <script>
                    function remove(id){
